...
might be able to get the same effect if you set C<PS4> as follows
...
version 2.05 bash or earlier versions. In versions after 3.0,
debugging should have been enabled when bash was built. (I think this
is usually the case though.) If you try to run the bashdb script on
...
I<$Id: bashdb-man.pod,v 1.7 2007/01/20 18:42:01 rockyb Exp $>
