...
See the reference manual for how to to call the debugger from inside
your program.
...
file-to-array read routine (readarray), but bashdb has to be compiled
in a special way which needs access to the bash source code and
objects.
...
code and access to internal structures would make this more
efficient. 
...
I<$Id: bashdb-man.pod,v 1.3 2006/12/26 03:17:57 rockyb Exp $>
